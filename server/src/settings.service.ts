  ...
  async onModuleInit() {
    ...
    if (!settings) {
      const defaultSettings = this.settingsRepository.create({
        ...
        frontendSkills: ['Graphic Design', 'Adobe Creative Cloud', 'Figma', 'Digital Design', 'Responsive design', 'Communication', 'Problem Solving', 'Design Principles', 'Content Moderation', 'Visual Communication', 'UX collaboration', 'Design systems', 'Leadership', 'Analytical Skills', 'Remote Work Skills'],
        backendSkills: [
          'JavaScript (ES6+)',
          'HTML',
          'CSS',
        ...
        toolSkills: ['Jira', 'GitHub', 'Bitbucket', 'VS Code', 'AI Pair Programmers', 'Version Control Systems'],
      ...
      settings.frontendSkills = ['Graphic Design', 'Adobe Creative Cloud', 'Figma', 'Digital Design', 'Responsive design', 'Communication', 'Problem Solving', 'Design Principles', 'Content Moderation', 'Visual Communication', 'UX collaboration', 'Design systems', 'Leadership', 'Analytical Skills', 'Remote Work Skills'];
      settings.backendSkills = ['JavaScript (ES6+)', 'HTML', 'CSS', 'Sass', 'Agile Methodology', 'Bootstrap Utility Classes', 'Component libraries', 'Mobile-first engineering', 'Cross-browser compatibility'];
      settings.toolSkills = ['Jira', 'GitHub', 'Bitbucket', 'VS Code', 'AI Pair Programmers', 'Version Control Systems'];
