    ...
    this.settingsService.getSettings().subscribe({
      next: (data) => {
        ...
        this.seoService.updateMetaTags({
          title: 'Product-focused Designer & Frontend Developer | ' + data.siteTitle,
          url: 'hire-me',
          description: '15+ years in design and 10+ years building real-world applications. Focused on UI systems, visual clarity, and production-ready frontend.'
        });
      }
    });
