...
@Component({
  ...
  templateUrl: './work-with-me.html',
  styleUrl: './work-with-me.scss',
})
export class WorkWithMeComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.settingsService.getSettings().subscribe({
      next: (data) => {
        ...
        this.seoService.updateMetaTags({
          title: 'I Design and Build Modern Websites | ' + data.siteTitle,
          url: 'work-with-me',
          description: 'Helping businesses replace outdated websites with clean, fast, and effective digital experiences.'
        });
      }
    });
    ...
    this.projectService.getProjects().subscribe({
      next: (data) => {
        // Focus on visually strong + business-relevant work
